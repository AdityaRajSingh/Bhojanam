  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Thanks for Donating!</Text>
        <Text style={styles.description}>Your order has been successfully placed! The delivery boy will be there on time</Text>
